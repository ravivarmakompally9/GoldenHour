...
| Fact | Number | Source |
| --- | --- | --- |
| Strokes in India per year | More than 1.5 million | [Tezpur study, PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC13098905/) |
| Patients reaching hospital within the golden hour (60 min) | 5.3% | [South First, registry study](https://thesouthfirst.com/health/stroke-in-india/) |
| Patients reaching hospital within the 4.5-hour treatment window | 20.1% | [South First](https://thesouthfirst.com/health/stroke-in-india/) |
| Patients arriving more than 24 hours after symptoms began | 37.8% | [South First](https://thesouthfirst.com/health/stroke-in-india/) |
| Ischaemic stroke patients given clot-busting treatment (thrombolysis) | 4.6% | [South First](https://thesouthfirst.com/health/stroke-in-india/) |
| Patients dead at 3 months | 27.8% | [South First](https://thesouthfirst.com/health/stroke-in-india/) |
| Patients with significant disability at 3 months | 29.7% | [South First](https://thesouthfirst.com/health/stroke-in-india/) |
| Brain cells lost per minute during a stroke | About 19 lakh (1.9 million) neurons | [South First](https://thesouthfirst.com/health/stroke-in-india/) |

**Root cause: recognition, not treatment.** Experts cite poor knowledge of early stroke signs and of the need to seek help urgently ([Journal of Neurosciences in Rural Practice](https://ruralneuropractice.com/acute-ischemic-stroke-and-the-golden-hour-critical-updates/)). A typical story: a grandmother's face droops slightly, her speech slurs, the family thinks she is tired and waits until morning.

**Why checking by eye is not enough.** The standard bedside checks are qualitative. They have high specificity but low sensitivity, 11% to 33% ([iPronator study, PLOS One](https://journals.plos.org/plosone/article?id=10.1371%2Fjournal.pone.0041544)). Mild weakness is easy to miss.
...
The product is designed around the iQOO Hackathon 2026 rules: phone-first, AI-first, judged on the iQOO phone. Sources: the organisers' WhatsApp FAQ, [iqoo.reskilll.com](https://iqoo.reskilll.com/cities) and the [Reskilll blog](https://reskilll.com/blogs/iqoo-hackathon-2026-india-phone-first-ai-hackathon-iqoo-reskilll/).
...
| --- | --- | --- |
| FAST.AI (Neuronics Medical, UCLA-linked) | 269 acute stroke patients. Facial asymmetry detection: 99.42% sensitivity, 93.67% specificity. Arm weakness: 71.42% sensitivity. | [Healio](https://www.healio.com/news/neurology/20230209/mobile-app-shows-promise-for-realtime-stroke-detection) |
| FAST.AI limitations | Test data sent to a server for analysis; screenings run by neurologists, not families | [Inside Precision Medicine](https://www.insideprecisionmedicine.com/news-and-features/smartphone-app-helps-detect-stroke-early/), [India.com](https://www.india.com/technology/this-smartphone-app-may-help-spot-stroke-symptoms-in-real-time-5882806/) |
| iPronator (PLOS One, 2012) | Handheld-device accelerometer app measured arm drift in 10 acute stroke patients vs 10 healthy controls | [PLOS One](https://journals.plos.org/plosone/article?id=10.1371%2Fjournal.pone.0041544) |
| NeuFun-TS (BMC Neurology, 2025) | Smartphone accelerometer sway and drift tests work as measures of neurological disability | [BMC Neurology](https://link.springer.com/article/10.1186/s12883-025-04038-2) |
...
| S2 | Language | English, हिंदी, తెలుగు buttons | First launch only; changeable in Settings |
...
- **Chrome-forcing link:** share `intent://<user>.github.io/goldenhour/#Intent;scheme=https;package=com.android.chrome;end` instead of the plain URL. iQOO phones may default to vivo's browser, and some apps open links in their own mini-browser; the install button only works in Chrome (or Samsung Internet).
...
```latex
A_{lm} = \frac{|lift_L - lift_R|}{\max(lift_L, lift_R)} \qquad A_{bs} = |mouthSmileLeft - mouthSmileRight| \qquad F = 0.7\,A_{lm} + 0.3\,A_{bs}
```
...
| Hindi | आज हैदराबाद में आसमान नीला है। | 6 | On-device multilingual Whisper (lower accuracy) |
| Telugu | ఈ రోజు హైదరాబాద్‌లో ఆకాశం నీలంగా ఉంది. | 5 | Web Speech API only (needs internet); on-device Telugu is a P3 goal |
...
- **Text normalisation:** lowercase, remove punctuation and the Hindi danda (।), Unicode NFC normalise, split on spaces.
...
| --- | --- |
| No baseline | Either arm `A` > 12°; or the left–right difference > 8° |
...
If Monster Halo is not controllable, use a flashlight strobe (`CameraManager.setTorchMode`) after the camera tests end. Specs from [iQOO community](https://community.iqoo.com/in/thread/124250) and [TelecomTalk](https://telecomtalk.info/?p=1001994).
...
| NOT\_COMPLETED | The patient could not do the test (counts as a warning sign for core tests) |
| NOT\_TESTED | A technical problem stopped the test (permission denied, missing sensor, skipped by EMERGENCY NOW) |
...
| ID | Condition | Result |
| --- | --- | --- |
| R1 | EMERGENCY NOW pressed at any time | HIGH ALERT immediately; remaining tests marked NOT\_TESTED |
| R2 | Any core test (Face, Speech, Arm) is ABNORMAL | HIGH ALERT |
| R3 | Any core test is NOT\_COMPLETED | HIGH ALERT, reason "could not complete \[test\]" |
| R4 | All core tests NOT\_TESTED | Amber: "Could not run the tests. If you are worried, call 108." with Call button |
| R5 | Otherwise (all core tests NORMAL or NOT\_TESTED) | NO CLEAR SIGNS screen, with extended check offer |
| R6 | Extended test (Eyes, Balance) ABNORMAL | HIGH ALERT |
| R7 | Extended test NOT\_COMPLETED | INCONCLUSIVE (amber), advice to call 108 if worried |
...
| Person cannot do a core test | NOT\_COMPLETED, which triggers HIGH ALERT |
...
Sources: [Gemini free tier](https://perkstack.co/blog/gemini-api-free), [OpenRouter limits](https://openrouter.zendesk.com/hc/en-us/articles/39501163636379-OpenRouter-Rate-Limits-What-You-Need-to-Know), [Groq limits](https://klymentiev.com/blog/openrouter-free-tier).
...
- For HIGH\_ALERT, `family_message` must contain "108".
...
| Decision | family\_message template |
| --- | --- |
| HIGH\_ALERT | "{failed tests} showed warning signs of a possible stroke on the {side} side. Call 108 now. Note the time and keep them resting." |
| NO\_CLEAR\_SIGNS | "No clear warning signs were found in these checks. If you are still worried, call 108. Retest in 10 minutes." |
| COULD\_NOT\_TEST | "The checks could not be run on this phone. If you are worried, call 108." |
...
{
  "gh_settings": {
    "language": "en", "demoMode": true,
    "demoEmergencyNumber": "+9198XXXXXXXX", "demoEmergencyName": "Teammate A",
    "demoHospitalNumber": "+9197XXXXXXXX",
    "llmProvider": "gemini", "voice": true, "developerMode": false
  },
  "gh_profile": {
    "name": "Lakshmi", "age": 68, "sex": "F", "bloodGroup": "B+",
    "diabetic": "yes", "bpMedicine": "yes", "bloodThinners": "no", "bloodThinnerName": "",
    "allergies": "none", "otherConditions": ""
  },
  "gh_contacts": [
...
| `decision.js` | `decide(core, extended, emergencyNow)` | "HIGH\_ALERT", "NO\_CLEAR\_SIGNS", "COULD\_NOT\_TEST" or "INCONCLUSIVE" |
...
The app goes live by pushing plain files to GitHub; there is no build step. Follow these steps once, then only steps 6–7 on each update.

1. **Create the repo.** A public GitHub repository named `goldenhour`, with the folder structure above.
2. **Add the offline files.** Download MediaPipe Tasks Vision (JS + WASM folder), `face_landmarker.task`, Chart.js, qrcode-generator and html2canvas at pinned versions into `/vendor` and `/models`. Do not rely only on CDN links (C20).
3. **Turn on hosting.** Repo Settings → Pages → Deploy from a branch → `main`, folder `/ (root)`. After 1–2 minutes the app is at `https://<user>.github.io/goldenhour/`.
4. **Get a free LLM key (optional, for F14).** Gemini: sign in to Google AI Studio → Get API key (no credit card). Backup: openrouter.ai → Keys → Create key, and pick a model whose ID ends in `:free`. Never paste keys into code (C5).
5. **First run on the phone.** Open the Chrome intent link (F1) → Install → open from the icon → allow camera, microphone and location → Settings: enter the demo emergency number, demo hospital number and API key → add a teammate as the primary contact → run every test once while online, so the Whisper model is cached for offline use.
6. **Every update.** Bump the cache version in `sw.js`, push, then on the phone tap "Update available — tap to reload".
7. **Debugging.** Enable USB debugging on the phone, connect it to the laptop and open `chrome://inspect` in desktop Chrome to see the phone's console and errors.
8. **Before sharing the repo link** (deck or judges): search the code for keys and phone numbers; there must be none (C2, C5).
...
The prototype is honest about what it cannot do; every limitation below has a stated workaround or is disclosed in the pitch.

**Assumptions**

| ID | Assumption |
| --- | --- |
| A1 | The phone is Android with a recent Chrome, a camera, a microphone and a gyroscope |
| A2 | A helper is present, or the patient can test themselves |
| A3 | Mobile signal is available for calls and SMS (tests themselves need no signal) |
| A4 | For core tests the person can sit and follow simple instructions; otherwise the test is NOT COMPLETED |
| A5 | At least one teammate or consenting friend can act as the demo emergency number and contacts |
| A6 | A team member speaks Hindi and/or Telugu to write and check translations |
| A7 | The Hyderabad submission deadline has not passed (to be confirmed on the dashboard) |
| A8 | The Gemini or OpenRouter free tier is reachable from India from a browser |
| A9 | The iQOO 15 given on-site runs Chrome and allows camera, mic and sensor access |

**Known limitations**

| ID | Limitation | How we handle it |
| --- | --- | --- |
| L1 | Thresholds are not clinically validated | Stated in the deck; clinical validation with neurologists is the next step |
| L2 | FAST-style checks miss some strokes | Extended BE-FAST check; "call 108 if still worried" always shown |
| L3 | On-device Whisper Tiny is weak in Hindi and not used for Telugu in Part 1; Telugu uses the cloud Web Speech API | Disclosed; AI4Bharat Indic speech models are a Part 2 goal |
| L4 | Whisper may "auto-correct" mild slurring | Timing metrics and personal baseline |
| L5 | A PWA cannot call or send SMS by itself; the helper confirms | Countdown opens the SMS app pre-filled; native app auto-sends |
| L6 | Multi-recipient SMS links behave differently across phones | One contact per tap |
| L7 | Install popup may be delayed; silent install is impossible | Fallback "⋮ → Install app" text |
| L8 | A web page cannot change screen brightness | High-contrast card; native app sets max brightness |
| L9 | Face accuracy drops in poor light, with beards or a turned head | Quality filter, retry prompts, "turn on a light" hint |
| L10 | Arm results vary with how the phone sits on the palm | Clear illustration; readiness check; left-right comparison |
| L11 | Free LLM tiers have limits and can return busy errors | One request per check; template fallback; backup provider |
| L12 | Free Gemini inputs may be used by Google to improve products | Fictional data only; name never sent |
| L13 | WebGPU is not on every phone; in-browser LLMs need 1–2 GB downloads | WASM fallback for Whisper; WebLLM only as a P2 experiment |
| L14 | Unknown whether apps can control the Monster Halo light | Verify on-site; flashlight strobe fallback |
| L15 | Full NPU use is uncertain in 30 hours | "NPU-accelerated where supported" |
| L16 | Symptoms of a mini-stroke may disappear before the test | App says symptoms that come and go are still an emergency |

**Risks**

| Risk | Impact | Mitigation |
| --- | --- | --- |
| Real 108 dialled by accident | Very high | Demo Mode locked; short codes blocked (C1) |
| A model fails to load on the demo phone | High | Vendored files, offline cache, test on the iQOO 15 early on-site, template fallbacks |
| False alarm in front of judges | Medium | Calibration, personal baseline, rehearsed demo |
| LLM quota runs out during the demo | Medium | Template fallback; LLM off during calibration; backup provider |
| Judges challenge novelty (FAST.AI exists) | Medium | Differentiators slide (Section 6) |
| Judges challenge medical safety | Medium | Rule-based decision, fixed wording, disclaimers (Section 11) |
| iQOO default browser opens the link | Medium | Chrome intent link (F1) |
| Left and right sides swapped on camera | Medium | Side decided by image position; verified in calibration |
| Noisy or dim venue spoils speech or face tests | Medium | Noise and light hints; demo in a quieter, well-lit spot |
| Submission deadline missed | Very high | Submit a first version immediately; it stays editable |

### Open decisions (confirm before building)

These choices are not settled yet. If nobody answers, developers use the default in the last column.

| Decision | Options | Default if not answered |
| --- | --- | --- |
| Demo video language | English (speech test fully on-device) or Telugu (speech needs internet in Part 1) | English for the video; Telugu shown in the UI and voice guidance |
| Team size and workstream owners | 1–3 people, each owning workstreams from Section 15 | One person per workstream, WS0 first |
| Team category | Students or working professionals (cannot mix) | Confirm on the dashboard before submitting |
| Who is the demo emergency number and primary contact | A teammate or a consenting friend, on a different phone | A teammate |
| LLM provider for Part 1 | Gemini free, OpenRouter free, or none (templates only) | Gemini free, OpenRouter as backup |
| Exact Hyderabad submission deadline | Date and time from the dashboard | Treat it as today; submit a first version now |
| Hospitals for `hospitals.json` | 5–10 Hyderabad hospitals verified by phone or official website | Leave F19 off until verified (C16) |
| On-site path | Full native Kotlin port, or the PWA on the iQOO 15 plus finished native parts | Decide at the hour-18 checkpoint (Section 21) |

## 18. Privacy, Safety and Compliance

Health data stays on the phone and is shared only in an emergency, only with people the user chose. This follows the principles of India's DPDP Act 2023: consent, minimal data and use only for the stated purpose.

**What is shared, when, with whom**

| Data | Stored | Shared with | When |
| --- | --- | --- | --- |
| Medical profile | Phone only | Doctor (card), contacts (SMS summary) | Only after a HIGH ALERT, by the helper's action |
| Test results | Phone only | Same as above | Same |
| Location | Phone only (last known) | Contacts | Only in the alert message |
| Face snapshot | Memory, current session only | Nobody (shown on the phone's card only) | Never sent |
| Anonymised check (no name) | Not stored remotely | LLM provider | Once per completed check, when online |

**Consent**

- Setup shows: "GoldenHour stores this information only on this phone. It is shared only if you send an emergency alert." The Setup User ticks "The person being protected agrees to this setup."
- Contacts must be told they are added (a one-time "You've been added as an emergency contact" SMS is optional, P2).

**Security**

- Part 1 stores data unencrypted in `localStorage` (a prototype limitation). Part 2 encrypts it with Android Keystore.
- API keys are entered on the phone and never leave it except in requests to the chosen provider.

**Medical and regulatory positioning**

- Required disclaimer on the Home screen, Doctor Card, deck and pitch: "GoldenHour is a screening aid that prompts people to seek emergency care. It is not a diagnostic device and does not replace a doctor."
- Software intended to diagnose disease can be regulated as a medical device. GoldenHour is positioned as a screening and triage aid; any real launch would need regulatory review and clinical validation.
- The app never recommends any medicine, including aspirin.

## 19. Calibration and Testing Plan

Thresholds are set by recording teammates normally and with deliberately faked symptoms, then choosing values that separate the two. Before calibration, the app uses the starting values below (stored in `js/thresholds.js`).

**Default thresholds (starting values)**

| Test | Metric | No baseline: abnormal if | With baseline: abnormal if |
| --- | --- | --- | --- |
| Face | Smile asymmetry `F` | > 0.35 | > baseline + 0.20 |
| Face | Resting droop `D_rest` | > 0.08 | > baseline + 0.05 |
| Face | Minimum smile lift | < 0.03 means retry | same |
| Speech | Word Error Rate | > 0.30 | > baseline + 0.25 |
| Speech | Speech rate | < 1.2 words/s | < 70% of baseline |
| Speech | Pause ratio | > 0.40 | > baseline + 0.20 |
| Arm | Arm score `A` (either arm) | > 12° | > that arm's baseline + 8° |
| Arm | Left–right difference | > 8° | > baseline difference + 6° |
| Arm | Drop detection | > 45° from start, or spike > 20 m/s² | same |
| Eyes | Gaze off-centre (both eyes, same side) | > 0.2 from centre in > 70% of frames | same |
| Eyes | Side-vision misses | ≥ 2 of 3 on one side, both eyes | same |
| Balance | Eyes-closed RMS sway | > 0.25 m/s² | > 2 × baseline |

**Calibration protocol**

1. Turn on Developer mode and Calibration mode (F16). Turn the LLM off.
2. Each teammate (initials only) does, per test, 5 normal runs and 5 simulated runs:
   - **Face:** normal big smile vs smiling with only one side of the mouth.
   - **Speech:** normal sentence vs slow, slurred speech with one word dropped.
   - **Arm:** steady arm vs letting one hand sink 15–20° and turn the palm inward over 10 seconds.
3. Export the CSV.
4. For each metric, set the threshold midway between the highest normal value and the lowest simulated value. If the two ranges overlap, set it closer to the normal side (we prefer false alarms to misses).
5. Update `thresholds.js` defaults, re-run 3 normal and 3 simulated runs to confirm, and record the numbers.
6. Check sides: the tester raises their right hand in the face test; the app must label it right.
7. The deck states: "Calibrated on \[N\] healthy volunteers, \[M\] runs, simulated symptoms."

**Test checklist**

| Area | Test | Pass condition |
| --- | --- | --- |
| Install | Intent link on 2 different Android phones | Installs; opens full-screen |
| Offline | Airplane mode after one online load | App, Face and Arm tests work; LLM falls back to template |
| Decision | Unit tests for `decide()` covering R1–R8 | All pass |
| Validation | Enter 108, 112, 100, 1091, a 9-digit number | All refused |
| Countdown | Let it run; cancel; leave app and return | Opens SMS at 0; cancel works; pauses in background |
| Links | Call, SMS, WhatsApp, maps | Correct demo number, message and location |
| Card | Scan QR with a second phone in airplane mode | Readable text |
| LLM | Valid key; wrong key; airplane mode; slow network over 8 s | Explanation, or template, never an empty screen |
| Guardrails | Force an LLM reply containing "you are fine" | Replaced by template |
| Voice | English, Hindi, Telugu | Spoken where the voice is installed; text always shown |
| Performance | Face test frame rate | 15 fps or more |
| Unit tests | WER function, arm metrics on synthetic angle data, phone validation | Correct values |
| iQOO 15 | Full run in the first hour on-site | Everything above still works |

## 20. Demo and Submission

The submission is a deck with a linked 60–90 second demo video and a live install link; the demo must show a real app catching a simulated stroke sign and triggering the alert flow.

**Submission deliverables**

| # | Deliverable | Format | Notes |
| --- | --- | --- | --- |
| 1 | Idea deck | PDF, 9 slides | No fixed template required; outline below |
| 2 | Demo video | 60–90 s, YouTube unlisted or Google Drive ("anyone with the link") | Linked on slide 9 |
| 3 | Live prototype | Chrome intent link + plain URL + QR code on slide 9 | Judges can install it in 3 taps |
| 4 | Code (optional) | Public GitHub repo link | Check there are no keys or real numbers first |

Submit a first version as soon as the deck exists; the submission stays editable until the deadline.

**Deck outline**

| Slide | Title | Content |
| --- | --- | --- |
| 1 | The hook | Lakshmi's story (fictional); "only 1 in 5 stroke patients reaches hospital in time" |
| 2 | Root cause | A recognition failure at home, not a treatment failure; key numbers (Section 2) |
| 3 | GoldenHour | One-liner, pitch line, BE-FAST flow (core + extended) |
| 4 | The phone is the instrument | Seven phone features; iQOO 15 hardware table (F21) |
| 5 | AI architecture | On-device MediaPipe and Whisper, personal baseline, rule-based alert, LLM explanation |
| 6 | Evidence and what's new | FAST.AI and iPronator as proof; our five differentiators |
| 7 | Connected care | Family SMS example, Doctor Handoff Card, three connection tiers |
| 8 | Impact, safety, privacy | Adoption channels (adult children, ASHA workers, 108, hospitals/insurers); safety rules; offline privacy; disclaimer |
| 9 | Prototype and plan | Demo video link, install QR, calibration numbers, 30-hour Red/Green plan, team |

**Demo video script (about 80 seconds)**

| Time | Show | Voice-over |
| --- | --- | --- |
| 0–8 s | Home screen; tap the GoldenHour icon; app opens full-screen | "Every minute of a stroke costs about 19 lakh brain cells. GoldenHour turns any phone into a stroke first responder." |
| 8–14 s | Swipe down: airplane mode on | "Everything you're about to see runs offline, on the phone." |
| 14–30 s | Face test: teammate smiles normally → NORMAL | "On-device AI measures both sides of the smile." |
| 30–50 s | Arm test: teammate lets the right hand sink; live graph crosses the band → ABNORMAL | "Eyes closed, the weak arm drifts. The motion sensors catch it." |
| 50–56 s | Airplane mode off; HIGH ALERT screen | "Possible stroke. Call 108 now. In demo mode this calls a teammate. In real use it calls 108." |
| 56–68 s | Countdown → SMS opens pre-filled with location; the teammate's phone receives it (second camera) | "Family is alerted with live location, automatically." |
| 68–80 s | Doctor Handoff Card with QR; scan it with a second phone | "And the ER gets the facts that decide treatment, even offline." |

**Recording setup**

- Record the demo phone's screen with Android's built-in screen recorder.
- Film the person doing the tests (and the teammate's phone receiving the SMS) with a second phone.
- Put the two side by side with any free video editor. The screen recording alone cannot show the arm sinking.
- Use the fictional profile "Lakshmi, 68". Demo Mode banner visible throughout.
- Airplane mode blocks calls and SMS, so switch it off before the alert segment.

**Live on-site demo (about 3 minutes)**

1. Hand the iQOO 15 to a judge and let them do the arm test on themselves.
2. A teammate then fakes a sinking arm → HIGH ALERT.
3. The teammate's phone on the judges' table rings (demo call) and receives the SMS with location.
4. Open the developer panel to show live metrics (technical depth).
5. Show the Doctor Card and scan its QR.
6. Keep the demo video ready as a backup if anything fails.

## 21. On-Site Plan and Roadmap

On-site we port the working PWA to a native Kotlin app on the iQOO 15, organised around the Red Light / Green Light split. If the port falls behind, we still demo the PWA on the iQOO 15 with whatever native parts are finished.

**Before the event (by 25 Sep)**

- [ ] Install iQOO Office Kit on the laptop (pc.vivoglobal.com) and practise mirroring, remote control, file transfer and clipboard.
- [ ] Install Android Studio with the Android SDK; create and build an empty Kotlin + Compose project so Gradle caches are ready.
- [ ] Download model files to the laptop in advance (venue Wi-Fi may be slow): MediaPipe `face_landmarker.task`, a Whisper Tiny model for `whisper.cpp`, a small 4-bit Gemma model.
- [ ] Verify 5–10 Hyderabad hospitals for `hospitals.json` (C16).
- [ ] Hindi and Telugu strings checked by a native speaker (C17).
- [ ] Rehearse the 3-minute live demo twice.

**During the 30 hours**

| Phase | Tasks |
| --- | --- |
| First hour | Run the Part 1 PWA on the iQOO 15 end-to-end; confirm Chrome, camera, mic, sensors; check whether Monster Halo can be controlled |
| Red Light (phone only, about 55% of time) | Sensor tests on the iQOO 15; threshold tuning; baseline recording; LLM prompt tuning with the OpenRouter credits; UI fixes through Office Kit remote control; demo recordings; Telugu strings |
| Green Light (phone + laptop, about 45%) | Kotlin port of tests, decision and alerts; MediaPipe Android; `whisper.cpp`; on-device Gemma; direct call and auto-SMS; max brightness; hospital finder; flashlight or Monster Halo beacon |
| Throughout | Use Office Kit constantly (mirroring, file transfer, clipboard) so HackTracker records it |
| Around hour 18 | Checkpoint: if the native core flow (Arm → alert → call/SMS) is not working, switch to polishing the PWA on the iQOO 15 plus the finished native parts |
| Last 3 hours | Feature freeze; rehearse; record a backup demo video on the iQOO 15 |

**Roadmap after the city battle**

| Stage | Items |
| --- | --- |
| Grand Finale (Bengaluru, 9–11 Oct) | On-device Telugu speech (AI4Bharat Indic models); more models on the NPU; a doctor's review of wording and flow; verified hospital network for Hyderabad |
| Clinical | Validation with neurologists; train classifiers on real data (candidate public datasets such as Toronto NeuroFace for facial movement and TORGO for dysarthric speech, subject to licences) |
| Connected care (Tier 3) | Family guardian app with push alerts and live tracking; hospital pre-alert dashboard; 108 paramedic hand-off; ABHA health-record linking with consent |
| Distribution | Play Store release; ASHA-worker and old-age-home mode for screening many people |
| Adoption channels | Adult children setting it up for parents; ASHA workers; 108 services; hospitals and insurers, who save on disability and treatment costs |
...
| Term | Meaning |
| --- | --- |
| 108 | India's emergency ambulance number (Telangana included). Never dialled in the prototype. |
| BE-FAST | Balance, Eyes, Face, Arm, Speech, Time: the stroke warning-sign check |
| Blendshape | A 0–1 score from MediaPipe for one facial movement, e.g. `mouthSmileLeft` |
| Demo Mode | Prototype setting that sends every call and message to consenting teammates instead of 108, hospitals or family |
| Dysarthria / Aphasia | Slurred speech / trouble finding or understanding words |
| Golden hour | The first 60 minutes after stroke onset, when treatment helps most |
| HackTracker | The organisers' tool that records phone and Office Kit usage for scoring |
| Last known well | The last time the person was seen completely normal; starts the treatment clock |
| MFCC | Mel-frequency cepstral coefficients: numbers that describe the sound of a voice |
| NPU | Neural Processing Unit: the phone chip part built for running AI models |
| Office Kit | iQOO software linking phone and laptop (mirror, remote control, files, clipboard) |
| Personal baseline | The person's own healthy test values, recorded once and used for comparison |
| Pronator drift | A weak arm sinking and turning inward when held out with eyes closed |
| PWA | Progressive Web App: a website that installs and works like an app |
| Red Light / Green Light | Hackathon phases: phone only / phone and laptop |
| Thrombolysis | Clot-busting treatment for ischaemic stroke, time-limited (about 4.5 hours) |
| TWA | Trusted Web Activity: wraps a PWA as an Android APK |
| WER | Word Error Rate: share of expected words that were wrong or missing |

**References**

- [Stroke admission timings, Tezpur Medical College (PMC)](https://pmc.ncbi.nlm.nih.gov/articles/PMC13098905/)
- [Nearly 4 in 10 stroke patients in India wait more than a day (The South First)](https://thesouthfirst.com/health/stroke-in-india/)
- [India's growing stroke crisis (The Week)](https://www.theweek.in/news/health/2026/04/27/indias-growing-stroke-crisis-why-ncd-control-must-go-beyond-metro-centres.html)
- [Acute ischemic stroke and the golden hour (J. Neurosciences in Rural Practice)](https://ruralneuropractice.com/acute-ischemic-stroke-and-the-golden-hour-critical-updates/)
- [iPronator: objective pronator drift test app (PLOS One)](https://journals.plos.org/plosone/article?id=10.1371%2Fjournal.pone.0041544)
- [Smartphone postural sway and pronator drift tests (BMC Neurology)](https://link.springer.com/article/10.1186/s12883-025-04038-2)
- [FAST.AI results (Healio)](https://www.healio.com/news/neurology/20230209/mobile-app-shows-promise-for-realtime-stroke-detection)
- [FAST.AI study details (Inside Precision Medicine)](https://www.insideprecisionmedicine.com/news-and-features/smartphone-app-helps-detect-stroke-early/)
- [FAST.AI study limitation (India.com)](https://www.india.com/technology/this-smartphone-app-may-help-spot-stroke-symptoms-in-real-time-5882806/)
- [iQOO Hackathon 2026 overview (Reskilll blog)](https://reskilll.com/blogs/iqoo-hackathon-2026-india-phone-first-ai-hackathon-iqoo-reskilll/)
- [iQOO Hackathon 2026 site](https://iqoo.reskilll.com/cities)
- [iQOO 15 specifications (iQOO community)](https://community.iqoo.com/in/thread/124250)
- [iQOO 15 launch details (TelecomTalk)](https://telecomtalk.info/?p=1001994)
- [Gemini API free tier](https://perkstack.co/blog/gemini-api-free)
...
- [OpenRouter free tier and Groq limits](https://klymentiev.com/blog/openrouter-free-tier)
- [WebLLM](https://www.Github.com/mlc-ai/web-llm)
